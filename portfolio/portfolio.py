...
# ============================================================
GITHUB_REPOS = {
    "retail": "https://github.com/abdullahA7med/Data-Analysis-projects/tree/main/Retail_Store_Analytics",
...
# Tabs - NEW PROJECT FIRST
tab1, tab2, tab3, tab4 = st.tabs(["🏪 Retail Store", "🌤️ Weather", "🛒 Sales", "👥 HR"])

BASE_DIR = os.path.dirname(os.path.abspath(__file__))

# ==================== TAB 1: RETAIL STORE (NEW - FIRST) ====================
with tab1:
    st.markdown('<div class="project-content">', unsafe_allow_html=True)
    st.markdown("""
    <div class="project-header">
        <div class="project-title">Retail Store Analytics Dashboard | نور للتجارة</div>
        <div class="project-badges">
            <span class="badge">Python</span>
            <span class="badge badge-purple">Power BI</span>
            <span class="badge badge-pink">DAX</span>
            <span class="badge">ETL</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
    
    st.markdown('<div class="project-desc">Comprehensive BI solution for multi-branch retail analytics. End-to-end data pipeline cleaning 3,400+ data quality issues and 6-page interactive dashboard with 74.9M SAR revenue analysis.</div>', unsafe_allow_html=True)
    
    # Key Metrics
    st.markdown('<div class="metrics-row">', unsafe_allow_html=True)
    c1, c2, c3, c4 = st.columns(4)
    with c1: st.markdown('<div class="metric-box"><div class="metric-value">74.9M</div><div class="metric-label">Revenue (SAR)</div></div>', unsafe_allow_html=True)
    with c2: st.markdown('<div class="metric-box"><div class="metric-value">15.5%</div><div class="metric-label">Profit Margin</div></div>', unsafe_allow_html=True)
    with c3: st.markdown('<div class="metric-box"><div class="metric-value">18</div><div class="metric-label">Months</div></div>', unsafe_allow_html=True)
    with c4: st.markdown('<div class="metric-box"><div class="metric-value">6</div><div class="metric-label">Pages</div></div>', unsafe_allow_html=True)
    st.markdown('</div>', unsafe_allow_html=True)
    
    st.write("\n**Key Features:**")
    st.write("- Production-grade ETL pipeline (pandas, numpy)")
    st.write("- 3,400+ null values handled intelligently")
    st.write("- 6 comprehensive dashboard pages")
    st.write("- Dark theme UI with Saudi national colors")
    st.write("- Time series analysis (18 months)")
    st.write("- Branch, Product, Employee, Time analytics")
    
    st.write("\n**Data Cleaning Achievements:**")
    st.markdown('<div class="insight-box">✅ Fixed 3,400 missing dates, 200 negative quantities, 100 future dates</div>', unsafe_allow_html=True)
    st.markdown('<div class="insight-box">✅ Standardized phone numbers to Saudi format (+966-5XX-XXX-XXXX)</div>', unsafe_allow_html=True)
    st.markdown('<div class="insight-box">✅ Removed duplicates while preserving valid variations</div>', unsafe_allow_html=True)
    
    st.link_button(" View on GitHub", GITHUB_REPOS["retail"], type="secondary")
    
    # Dashboard Screenshots - 6 Pages
    st.markdown("\n---\n")
    st.markdown("###  Dashboard Pages")
    
    col1, col2 = st.columns(2)
    with col1:
        st.image(os.path.join(BASE_DIR, "assets", "retail", "home.png"), caption=" Home Page - Navigation Hub", use_container_width=True)
        st.image(os.path.join(BASE_DIR, "assets", "retail", "OverView.png"), caption="📊 Overview - Executive KPIs", use_container_width=True)
        st.image(os.path.join(BASE_DIR, "assets", "retail", "Branch.png"), caption="🏪 Branch Analysis", use_container_width=True)
    
    with col2:
        st.image(os.path.join(BASE_DIR, "assets", "retail", "Product.png"), caption="📦 Product Analytics", use_container_width=True)
        st.image(os.path.join(BASE_DIR, "assets", "retail", "Employee.png"), caption="👥 Employee Performance", use_container_width=True)
        st.image(os.path.join(BASE_DIR, "assets", "retail", "Time.png"), caption="⏰ Time Analysis", use_container_width=True)
...
with tab3:
    ...
    with col1:
        ...
        st.markdown('<div class="insight-box">Electronics = 94% - Accessories need focus</div>', unsafe_allow_html=True)
...
with tab4:
    ...
    with col1:
        ...
        st.write("**Insights:**")
        st.markdown('<div class="insight-box">Marketing: 40% turnover - critical risk</div>', unsafe_allow_html=True)
        st.markdown('<div class="insight-box">IT: Highest salary at 11.5K EGP</div>', unsafe_allow_html=True)
        st.markdown('<div class="insight-box">22% exceeds healthy benchmark (10-15%)</div>', unsafe_allow_html=True)
...
# ============================================================
# CONTACT SECTION - WITH ALL ICONS
# ============================================================
st.markdown("---")
st.markdown("""
<div class="contact-section">
    ...
    <a href="https://www.linkedin.com/in/abdullah-ahmed-562503375" class="contact-btn">🔗 LinkedIn</a>
...
st.markdown("""
<div class="footer">
    <p>Built with passion by Abdullah ahmed | Data Analyst Portfolio</p>
